...
class AddressAddedScreen extends StatefulWidget {
  ...
  @override
  State<AddressAddedScreen> createState() => _AddressAddedScreenState();
}

class _AddressAddedScreenState extends State<AddressAddedScreen>
                ...
                Column(
                  children: [
                    ...
                    FadeInAnimation2(
                      delay: 1.5,
                      child: Text(
                        "${"Your address have been successfully"}\n ${"added to your profile."}",
