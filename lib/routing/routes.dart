...
class _Routes {
  String path;
  String name;
  _Routes({required this.name, required this.path});
}
...
class Routes {
  ...
  static _Routes termUseScreen = _Routes(
    name: 'termUseScreen',
    path: '/ternUseScreen',
  );

  static _Routes profileComplete = _Routes(
  ...
  static _Routes aboutScreen = _Routes(
    name: 'aboutScreen',
    path: '/aboutScreen',
  );

  static _Routes feedbackFormScreen = _Routes(
    name: 'feedbackFormScreen',
    path: '/feedbackFormScreen',
  );

  static _Routes helpSupportScreen = _Routes(
    name: 'helpSupportScreen',
    path: '/helpSupportScreen',
  );

  static _Routes notificationScreen = _Routes(
    name: 'notificationScreen',
    path: '/notificationScreen',
  );

  static _Routes savedAddresses = _Routes(
    name: 'savedAddresses',
    path: '/savedAddresses',
  );
  ...
  static _Routes profileEditScreen = _Routes(
  ...
  static _Routes orderPlaced = _Routes(
    name: 'orderPlaced',
    path: '/orderPlaced',
  );

  static _Routes transectionScreen = _Routes(
    name: 'transectionScreen',
    path: '/transectionScreen',
  );

  static _Routes orderDetail = _Routes(
    name: 'orderDetail',
    path: '/orderDetail',
  );

  static _Routes viewStatusScreen = _Routes(
    name: 'viewStatusScreen',
    path: '/viewStatusScreen',
  );
  ...
  static _Routes newSubscription = _Routes(
